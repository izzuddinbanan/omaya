...
@section('title', 'Settings : User -> Create')
                ...
                <div class="card">
                    ...
                    <form method="POST" action="{{ route('admin.setting.user.store') }}">
                        ...
                        <div class="card-header">
                            <h4 class="card-title">Add New User Record</h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 pb-1">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('username') is-invalid @enderror" type="text" placeholder="e.g admin" autocomplete="off" name="username" value="{{ old('username') }}" autofocus="" required="" tabindex="1" />
                                        @error('username')
                                ...
                                <div class="col-md-6 pb-1">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('email') is-invalid @enderror" type="text" placeholder="e.g admin@synchroweb.com" autocomplete="off" name="email" value="{{ old('email') }}" autofocus="" required="" tabindex="1" />
                                        @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6 pb-1">
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control @error('permission') is-invalid @enderror" name="permission">
                                            <option value="">Please Select</option>
                                                <option value="r" {{ 'r' == old('permission') ? 'selected' : '' }}>Read</option>
                                                <option value="rw" {{ 'rw' == old('permission') ? 'selected' : '' }}>Read + Write</option>
                                        </select>
                                        @error('permission')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
