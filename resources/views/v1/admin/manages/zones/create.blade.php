...
@section('title', 'Manage : Zone -> Create')
        ...
        <div class="row match-height">
            <div class="col-md-12 col-12">
                <div class="card">
                    ...
                    <form method="POST" action="{{ route('admin.manage.zone.store') }}">

                        @csrf

                        <div class="card-header">
                            <h4 class="card-title">Add New Zone Record</h4>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 pb-1">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('name') is-invalid @enderror" type="text" placeholder="e.g Meeting Room" autocomplete="off" name="name" value="{{ old('name') }}" autofocus="" required="" tabindex="1" />
                                        @error('name')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group pb-1">
                                        ...
                                        <textarea name="remark" class="form-control @error('remark') is-invalid @enderror" tabindex="4" placeholder="e.g Only staff here ...">{{ old('remark') }}</textarea>
                                        @error('remark')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12">
                                    ...
                                    <button type="submit" class="btn btn-primary mr-1 waves-effect waves-float waves-light" tabindex="5">Create</button>
                                </div>
