...
@section('title', 'Manage : Rule -> Create')
        ...
        <div class="row match-height">
            <div class="col-md-12 col-12">
                <div class="card">
                    ...
                    <form method="POST" action="{{ route('admin.manage.rule.store') }}">

                        @csrf
                        <div class="card-header">
                            <h4 class="card-title">Add New Rule Record</h4>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 pb-1">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('name') is-invalid @enderror" type="text" placeholder="e.g Button Click" autocomplete="off" name="name" value="{{ old('name') }}" autofocus="" required="" tabindex="1" />
                                        @error('name')
                            ...
                            <div class="row">
                                <div class="col-md-6 pb-1">
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control" name="type" id="rule_type"  required="" tabindex="2">
                                ...
                                {{--<div class="col-md-6 pb-1">
                                    <div class="form-group">
                                        <label for="name">Priority <span class="text-danger">*</span></label>
                                        <input class="form-control @error('priority') is-invalid @enderror" type="number" placeholder="e.g 12" autocomplete="off" name="priority" value="{{ old('priority') }}" autofocus="" required="" tabindex="1" />
                                        @error('priority')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="row" id="event_location_fied" style="display: none;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control" name="comparison" tabindex="">
                                            ...
                                            @foreach(config('custom.rules.comparison') as $key => $val)
                                                <option value="{{ $key }}" {{ $key == old('comparison') ? 'selected' : '' }}>{{ $val }}</option>
                                            @endforeach
                                        </select>
                                        <div>
                                ...
                                <div class="col-md-6 pb-1">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('value') is-invalid @enderror" type="number" placeholder="e.g 12" autocomplete="off" name="value" value="{{ old('value') }}" autofocus=""/>
                                        @error('value')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 pb-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control flatpickr-time text-start @error('start_time') is-invalid @enderror" placeholder="HH:MM" autocomplete="off" name="start_time" value="{{ old('start_time') }}" autofocus=""  required="" />
                                        @error('start_time')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6 pb-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control flatpickr-time text-start @error('end_time') is-invalid @enderror" placeholder="HH:MM" autocomplete="off" name="end_time" value="{{ old('end_time') }}" autofocus=""  required="" />
                                        @error('end_time')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control" name="send[]" id="" tabindex="" multiple required>
                                            @foreach(config('custom.rules.trigger') as $key => $val)
                                                <option value="{{ $key }}" {{ in_array($key, old('send', [])) ? 'selected' : '' }}>{{ ucfirst($val) }}</option>
                                            @endforeach
                                        </select>
                                        <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control" name="send_to[]" id="" multiple required>
                                            @foreach($data['admin_group'] as $admin)
                                                <option value="{{ $admin->admin_group }}" {{ in_array($admin->admin_group, old('send_to', [])) ? 'selected' : '' }}>{{ $admin->admin_group }}</option>
                                            @endforeach
                                        </select>
                                        <div>
                                ...
                                <div class="col-md-6 pb-1">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('action_every') is-invalid @enderror" type="text" placeholder="e.g 30" autocomplete="off" name="action_every" value="{{ old('action_every') }}" autofocus="" required="" tabindex="1" />
                                        @error('action_every')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="col-12">
                                ...
                                <button type="submit" class="btn btn-primary mr-1 waves-effect waves-float waves-light" tabindex="">Create</button>
                            </div>
...
<script type="text/javascript">
    ...
    var old_identifier = {!! json_encode(old('identifier')) !!}
    var old_event      = {!! json_encode(old('event')) !!}
    var old_location   = {!! json_encode(old('location')) !!}
