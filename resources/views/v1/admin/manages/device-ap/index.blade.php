...
@section('title', 'Manage : Device [ Access Point ]')
...
@section('button-right')
    ...
    @if(able_to("manage", "device-ap", "rw"))
        <a href="{{ route('admin.manage.device.import') }}">
            <button type="button" class="btn btn-primary btn-sm">
                <i data-feather="download" class="mr-25"></i>
                <span>Import</span>
            </button>
        </a>
        <a href="{{ route('admin.manage.device-ap.create') }}">
            <button type="button" class="btn btn-primary btn-sm">
                                ...
                                <tbody>
                                    ...
                                    @foreach($devices as $device)
                                        <tr>
                                            ...
                                            <td>{{ $device->zone ? $device->zone->name : "-" }}</td>
                                            ...
                                            <td>
                                                ...
                                                @if(able_to("manage", "device-ap", "r"))

                                                    <a href="{{ route('admin.manage.device-ap.edit', [$device->device_uid]) }}" class="btn btn-icon btn-success btn-sm mr-1 fa fa-pencil" data-bs-toggle="tooltip" title="" data-bs-original-title="Edit"></a>
                                                 
                                                @endif

                                                @if(able_to("manage", "location", "rw"))

                                                    <a href="{{ route('admin.manage.device-ap.destroy', [$device->device_uid]) }}" class="ajaxDeleteButton btn btn-icon btn-danger btn-sm mr-1 fa fa-trash" data-bs-toggle="tooltip" title="" data-bs-original-title="Delete"></a>
