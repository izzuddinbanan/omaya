...
@section('title', 'Manage : Entity -> Create')
        ...
        <div class="row match-height">
            <div class="col-md-12 col-12">
                <div class="card">
                    ...
                    <form method="POST" action="{{ route('admin.manage.entity.store') }}">

                        @csrf

                        <div class="card-header">
                            <h4 class="card-title">Add New Entity [Staff, Visitor, Assets] Record</h4>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 pb-1">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('name') is-invalid @enderror" type="text" placeholder="e.g Technician" autocomplete="off" name="name" value="{{ old('name') }}" autofocus="" required="" tabindex="1" />
                                        @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control" name="device" tabindex="2">
                                            ...
                                            @foreach($devices as $device)
                                                <option value="{{ $device->device_uid }}" {{ old('device') ==  $device->device_uid ? 'selected' : ''  }}>{{ ucfirst($device->name) }}</option>
                                            @endforeach
                                        </select>
                                        <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control" name="group"  required="" tabindex="2">
                                            ...
                                            @foreach($groups as $group)
                                                <option value="{{ $group->group_uid }}" {{ old('group') ==  $group->group_uid ? 'selected' : ''  }}>{{ ucfirst($group->name) }}</option>
                                            @endforeach
                                        </select>
                                        <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control" name="meet_with" tabindex="2">
                                            ...
                                            @foreach($users as $user)
                                                <option value="{{ $user->entity_uid }}" {{ old('meet_with') ==  $user->device_uid ? 'selected' : ''  }}>{{ ucfirst($user->name) }}</option>
                                            @endforeach
                                        </select>
                                        <div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group pb-1">
                                        ...
                                        <textarea name="remark" class="form-control @error('remark') is-invalid @enderror" tabindex="3" placeholder="e.g Visitor - IT Technician ...">{{ old('remark') }}</textarea>
                                        @error('remark')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12">
                                    ...
                                    <button type="submit" class="btn btn-primary mr-1 waves-effect waves-float waves-light" tabindex="4">Create</button>
                                </div>
